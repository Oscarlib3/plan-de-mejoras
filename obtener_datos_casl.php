...
while($row = mysqli_fetch_assoc($query))
{
	...
	$sub_array[] = '<a href="javascript:void();" data-id="'.$row['id'].'"  class="btn btn-dark btn-sm editbtn" >Editar</a>  <a href="javascript:void();" data-id="'.$row['id'].'"  class="btn btn-primary btn-sm deleteBtn" >Borrar</a>';
	$data[] = $sub_array;
}
