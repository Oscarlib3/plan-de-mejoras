...
<div class="container-fluid bg-primary">
  ...
  <h5 class="text-center">COORDINACION DE ADMINISTRACION DE SEGURIDAD LOGICA</h5>
  <div class="row">
    <div class="container">
      <?php if ($tipo_usuario == 1) { ?>
        ...
        <?php if ($tipo_usuario == 3) { ?>
          <div class="btnAdd ">
            <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-dark btn-lg">AGREGAR NUEVA MEJORA</a>
          <?php } ?>
          <button id="btnBD1" type="button" class="btn btn-info btn-lg">GRAFICOS DE LAS MEJORAS</button>
          </div>
            ...
            <div class="row bg-white">
              <table id="example" class="table table-striped table-bordered table-condensed text-center" style="width: 100%">
                <thead class="bg-dark text-primary">
                  ...
                  <?php if ($tipo_usuario == 3) { ?><th scope="col">OPCIONES</th><?php } ?>
                </thead>
                <tbody>
                </tbody>
              </table>
...
<script type="text/javascript">
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if (status == 'true') {
            ...
            var button = '<td> <a href="javascript:void();" data-id="' + id + '" class="btn btn-dark btn-sm editbtn">Editar</a>   <a href="#!"  data-id="' + id + '"  class="btn btn-primary btn-sm deleteBtn">Borrar</a></td>';
  ...
  $('#example').on('click', '.editbtn ', function(event) {
    ...
    $.ajax({
      url: "../datos_individuales_casl.php",
      data: {
        id: id
      },
      type: 'post',
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body bg-primary fw-bold">
        <form id="updateUser">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="contenedor-modal1" style="min-width: 630px; height: 400px; margin:0 auto"></div>
...
<script src="../js/codigoJS1.js"></script>
</body>
