...
<div class="container-fluid bg-danger">
  ...
  <h5 class="text-center">COORDINACION DE MONITOREO Y RESPUESTA DE INCIDENTES</h5>
  <div class="row">
    <div class="container">
      <?php if ($tipo_usuario == 1) { ?>
        ...
        <?php if ($tipo_usuario == 2) { ?>
          <div class="btnAdd ">
            <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-dark btn-lg">AGREGAR NUEVA MEJORA</a>
          <?php } ?>
          <button id="btnBD" type="button" class="btn btn-info btn-lg">GRAFICOS DE LAS MEJORAS</button>
          </div>
            ...
            <div class="row bg-white">
              <table id="example" class="table table-striped table-bordered table-condensed text-center" style="width: 100%">
                <thead class="bg-dark text-danger">
                  ...
                  <?php if ($tipo_usuario == 2) { ?><th scope="col">OPCIONES</th><?php } ?>
                </thead>
                <tbody>
                </tbody>
              </table>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body bg-danger fw-bold">
        <form id="updateUser">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="contenedor-modal" style="min-width: 630px; height: 400px; margin:0 auto"></div>
